...
ACTIONS = {
    ...
    "remember": "You try to remember the meaning for ",
...
SANTA = [
    "You hear footsteps above you. Someone is upstairs wearing heavy boots.",
    "The footsteps above you are getting louder.",
    "You hear a door opening on the second floor. 'HO HO HO'",
    "You hear footsteps near the top of the stairs. Bells jingle.",
    "You hear loud footsteps taking a step down the stairs.",
    "You hear more loud footsteps. Someone is coming down the stairs." ,
    "You hear another loud step. You see two large black boots at the top of the stairs.",
    "You hear another loud step. You see two large boots and red pants.\n'HO HO HO'",
    "You hear another loud step. You see two large boots, red pants, and a black belt.",
    "You hear a few more loud steps. You see two large boots, red pants, a black belt, and a red jacket.",
    "You hear the foot steps behind you."
]
 
SANTA_DEAD = "You've killed Santa... but where is your brother?"
SANTA_KILLS = "Santa hits you with his sack of toys. You fall to the floor."
...
WORD_DEFINITIONS = {
    ...
    "pitch": "(adj) often used to make the adjective 'pitch black'; very very dark.",
    "coal": "(n) a dark hard rock humans burn for energy.",
    "billion": "(n) 1, 000, 000, 000.",
    "lying": "(v) on the floor; not standing.",
    "stole": "(v) to take something without asking if you can take it.",
